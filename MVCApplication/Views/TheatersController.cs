...
namespace MVCApplication.Views
{
    public class TheatersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "movieID,capacity,showTime,theaterName,uuid")] Theater theater)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "movieID,capacity,showTime,theaterName,uuid")] Theater theater)
        {
            if (ModelState.IsValid)
            {
